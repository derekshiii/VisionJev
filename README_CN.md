...
[English](README.md) | 简体中文 · 分支：`drivejev` · [VisionJev 多模态主线](https://github.com/derekshiii/DriveJev/tree/visionjev)
...
真实单图推理已实测通过：0.8B adapter 在所测帧上选中了离线最优候选。该接口验证使用 **1,008 个图像 token**；上表驾驶评测配置使用 **364 个**。
...
GPU 独立复评得到 **0.8B：221/324（68.21%）**、**9B：283/324（87.35%）**，与原始保存结果各差一个平局样本。表格与图继续保留原始实验成绩。
